...
while not game_over:
    ...
    for event in pygame.event.get():
        ...
        if turn == 1 and not game_over:# pour pas qu'elle joue si le jeu est terminé 
            pygame.time.wait(500)
            
            col = random_piece(board) #on veut modifier la colone pour tous les algorithmes, c'est la seule chose a changer
